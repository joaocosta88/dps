...
public partial class S3Service {
	...
	public async Task<IList<UploadFileToS3Response>> UploadFiles(IList<UploadFileToS3Request> req)
	{
	...
	public async Task<UploadFileToS3Response> UploadFile(UploadFileToS3Request req)
	{
